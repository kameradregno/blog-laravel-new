    <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 border-top fixed-bottom bg-white">
        ...
        <ul class="nav col-md-4 justify-content-end list-unstyled d-flex me-5">
            <li class="ms-3"><a class="text-body-secondary" href="#"><svg width="24" height="24"
                        ...
                        <path class="cls-1" d="M24,15.72A8.28,8.28,0,1,0,32.28,24h0A8.28,8.28,0,0,0,24,15.72Z" />
                    </svg></a></li>
            ...
            <li class="ms-3"><a class="text-body-secondary" href="#"><svg width="24" height="24"
                        viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#000000">
                        <line x1="40" y1="28" x2="27.88" y2="41.92" />
                        <polygon points="48 56 56 8 8 28 48 56" />
                    </svg></a></li>
        </ul>
    </footer>
